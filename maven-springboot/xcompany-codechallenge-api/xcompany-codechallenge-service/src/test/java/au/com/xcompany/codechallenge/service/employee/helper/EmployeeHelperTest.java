        ...
        when(employeeDao.findSubordinatesByManagerId(any())).thenAnswer(new Answer<List>() {
            ...
            public List answer(InvocationOnMock invocationOnMock) throws Throwable {
                ...
                if (localManagerID.equals(MANAGER_ID)) {
                    au.com.xcompany.codechallenge.db.entity.Employee sub =
                            new au.com.xcompany.codechallenge.db.entity.Employee(SUB_ID, SUB_NAME, MANAGER_ID);
                    List<au.com.xcompany.codechallenge.db.entity.Employee> subs = new ArrayList<>();
                    subs.add(sub);
                    return subs;
                } else {
