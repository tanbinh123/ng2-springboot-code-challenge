...
public class EmployeeServiceImplTest {
    ...
    private List<au.momenton.codechallenge.db.entity.Employee> getDaoEmployee(
            Long id, String firstName, Long managerID) {
        List<au.momenton.codechallenge.db.entity.Employee> employees = new ArrayList<>();
        au.momenton.codechallenge.db.entity.Employee independent =
                new au.momenton.codechallenge.db.entity.Employee(id, firstName, managerID);
